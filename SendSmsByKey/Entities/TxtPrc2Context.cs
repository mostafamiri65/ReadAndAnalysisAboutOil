...
public partial class TxtPrc2Context : DbContext
{
    public TxtPrc2Context()
    {
    }

    public TxtPrc2Context(DbContextOptions<TxtPrc2Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=192.168.1.37;Database=TxtPrc2;User Id = sa;Password = M13961221@;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<NewsRssReed2>(entity =>
        {
            ...
            entity.Property(e => e.ModifiedIp)
                .HasMaxLength(50)
                .IsUnicode(false);
            entity.Property(e => e.NotOil).HasDefaultValue(false);
            entity.Property(e => e.ProcDate).HasColumnType("datetime");
            entity.Property(e => e.PublishedDate).HasMaxLength(100);
            entity.Property(e => e.Title).HasMaxLength(1000);
        });
        ...
        modelBuilder.Entity<SendSm>(entity =>
        {
            ...
            entity.Property(e => e.SendedText).HasMaxLength(200);
        });
